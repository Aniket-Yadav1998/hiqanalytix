    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 -z-10">
                ...
                <motion.span
                    className="absolute left-[10%] top-40 h-2 w-2 rounded-full bg-orange-500"
                ...
                />
                <motion.span
                    className="absolute left-[8%] bottom-40 h-1.5 w-1.5 rounded-full bg-orange-400"
                ...
                >
                    ...
                    >
                        ...
                        <span className="relative inline-block text-orange-500">
                            ...
                            <motion.span
                                aria-hidden
                                className="absolute -bottom-2 left-0 h-1 w-full origin-left bg-orange-500/80"
                                initial={{ scaleX: 0 }}
                                animate={{ scaleX: 1 }}
                        ...
                        >
                            <AnimatePresence mode="wait">
                                <motion.span
                                    ...
                                    className="font-display font-semibold text-orange-600"
                                >
                                    {rotators[idx]}
                                </motion.span>
                            </AnimatePresence>
                    ...
                    <div className="mt-10 flex flex-wrap items-center gap-4">
                        <a
                            ...
                            className="group inline-flex items-center gap-2 bg-orange-500 px-6 py-3.5 font-medium text-white shadow-lg shadow-orange-500/20 transition-all duration-200 hover:bg-orange-600 hover:shadow-orange-500/30"
                        >
