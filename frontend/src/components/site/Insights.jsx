...
const FALLBACK = [
    {
        id: "f1",
        title: "Making Power BI adoption measurable after launch",
        excerpt: "A practical operating model for turning dashboard usage, decision quality and ownership into measurable adoption signals.",
        category: "Power BI",
        read_minutes: 6,
    ...
    {
        id: "f2",
        title: "Choosing the right automation pattern for 2026",
        excerpt: "A clear framework for deciding when to use Power Automate, RPA or Copilot Studio across governed enterprise workflows.",
        category: "Automation",
        read_minutes: 8,
    ...
    {
        id: "f3",
        title: "Designing operational dashboards for faster decisions",
        excerpt: "The design principles that help operational teams interpret trusted data quickly and act on the constraints that matter.",
        category: "Automotive",
        read_minutes: 5,
    ...
    {
        id: "f4",
        title: "From fragmented workbooks to a governed reporting cycle",
        excerpt: "How a controlled Power BI and Power Automate process improves reconciliation, ownership and reporting confidence.",
        category: "Financial",
        read_minutes: 7,
    ...
    {
        id: "f5",
        title: "Connecting operational data to accountable action",
        excerpt: "Why reliable data models create value only when they connect insight, ownership and a defined response process.",
        category: "Energy",
        read_minutes: 6,
    ...
    return (
        ...
        >
            <div className="relative aspect-[16/10] w-full flex-none overflow-hidden sm:aspect-auto sm:h-auto sm:w-56">
                {p.image_url ? (
                    ...
                    <div className="grid h-full w-full place-items-center bg-brand-light">
                        <img src="/logo-transparent.png" alt="HARVESTIQ LLP" className="h-16 w-auto object-contain" />
                    </div>
                )}
            ...
            <div className="flex min-w-0 flex-1 flex-col justify-between p-6">
                ...
                <div className="mt-5 flex items-start justify-start gap-4 border-t border-neutral-100 pt-4">
                    <span className="text-xs tracking-[0.05em] text-neutral-500">
...
export default function Insights() {
    ...
    return (
        ...
        >
                ...
                <div className="grid gap-12 lg:grid-cols-12 lg:gap-16">
                    ...
                    <aside className="lg:col-span-4">
                        <div className="lg:sticky lg:top-28">
                            ...
                            <p className="mt-6 max-w-md text-base leading-relaxed text-neutral-800">
                                ...
                                automations and analytics practices. Written by the
                            ...
                            <div className="mt-8 hidden items-center gap-3 border border-neutral-200 bg-neutral-50 p-3 lg:flex">
                                ...
                                <div className="min-w-0">
                                    <div className="truncate text-xs uppercase tracking-widest text-neutral-500">
                                        Just published
                                    </div>
                                    <div className="truncate text-xs font-semibold text-neutral-900">
                                        {items[0]?.title || "Field notes from the field."}
                                    </div>
                                </div>
                            </div>
                            </div>
                    ...
                    <div className="lg:col-span-8">
                        ...
                        {items.length > 0 && remaining === 0 && (
                            <p className="mt-10 text-center text-xs tracking-[0.05em] text-neutral-500">
            ...
            {selectedPost && (
                <div
                    className="fixed inset-0 z-[60] flex items-center justify-center bg-neutral-950/80 backdrop-blur-sm"
                    role="dialog"
                    aria-modal="true"
                ...
                >
                    <article className="relative flex max-h-[90vh] w-[min(92vw,860px)] flex-col overflow-hidden border border-neutral-200 bg-white shadow-2xl">
                        <button
                            type="button"
                            onClick={() => setSelectedPost(null)}
                            aria-label="Close article"
                            className="absolute right-4 top-4 z-10 grid h-10 w-10 place-items-center border border-neutral-200 bg-white/95 text-neutral-600 shadow-sm transition-colors hover:border-brand hover:text-brand-dark"
                        >
                        ...
                        <div className="min-h-0 overflow-y-auto p-6 md:p-10">
                            ...
                            <h3 className="mt-5 pr-10 font-display text-3xl font-bold leading-tight text-neutral-900 md:text-4xl">
                                {selectedPost.title}
                            </h3>
