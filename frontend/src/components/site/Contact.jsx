        ...
        >
            <div className="mx-auto max-w-7xl px-6 lg:px-10">
                <div className="grid gap-16 lg:grid-cols-12 lg:gap-20">
                    ...
                    >
                        <span className="text-xs uppercase tracking-[0.25em] text-orange-600">Contact</span>
                        <h2
                        ...
                        <ul className="mt-10 space-y-5">
                            <li className="flex items-center gap-4 text-neutral-800">
                                ...
                                <a href="mailto:hello@hiqanalytix.com" className="text-sm hover:text-neutral-900">
                                    hello@hiqanalytix.com
                                </a>
                            </li>
                            <li className="flex items-center gap-4 text-neutral-800">
                                <span className="grid h-10 w-10 place-items-center border border-orange-200 bg-orange-50">
                                    <PhoneIcon weight="duotone" size={18} className="text-orange-500" />
                                </span>
