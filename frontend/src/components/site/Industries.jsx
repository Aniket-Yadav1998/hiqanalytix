...
const industries = [
    {
        ...
        img: "https://images.unsplash.com/photo-1590283603385-17ffb3a7f29f?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2NDF8MHwxfHNlYXJjaHwxfHxmaW5hbmNpYWwlMjBzZWN1cml0eSUyMG9wZXJhdGlvbnMlMjBkYXRhJTIwY2VudGVyfGVufDB8fHx8MTczNjgyMDk5N3ww&ixlib=rb-4.1.0&q=85&w=1200&h=1500&fit=crop",
    },
    {
        key: "automotive",
        title: "Automotive",
        desc: "Plant OEE, supplier scorecards and after-sales analytics — from assembly line to dealer network.",
        img: "https://images.unsplash.com/photo-1581091212991-8891c7d4bd9b?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjA1NzV8MHwxfHNlYXJjaHwyfHxtb2Rlcm4lMjBhdXRvbW90aXZlJTIwYXNzZW1ibHklMjBsaW5lJTIwcm9ib3RzfGVufDB8fHx8MTc4NjgyMDk5N3ww&ixlib=rb-4.1.0&q=85&w=1200&h=1500&fit=crop",
    },
    {
        key: "engineering",
        title: "Engineering",
        desc: "Project controls, resource utilisation and design-to-delivery visibility for EPC and consulting firms.",
        img: "https://images.unsplash.com/photo-1581094794329-c8112a89af12?crop=entropy&cs=srgb&fm=jpg&q=85&w=1200&h=1500&fit=crop",
    },
    {
        key: "energy",
        title: "Energy",
        desc: "Grid, generation and asset performance analytics for renewables, utilities and oil & gas operators.",
        img: "https://images.unsplash.com/photo-1466611653911-95081537e5b7?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDQ2MzR8MHwxfHNlYXJjaHwyfHx3aW5kJTIwdHVyYmluZXMlMjBzdW5zZXQlMjBlbmVyZ3klMjBwbGFudHxlbnwwfHx8fDE3ODY4MjA5OTd8MA&ixlib=rb-4.1.0&q=85&w=1200&h=1500&fit=crop",
    },
    {
        key: "health",
        title: "Health",
        desc: "Patient flow, revenue cycle and clinical quality dashboards — HIPAA-aware and audit-ready.",
        img: "https://images.unsplash.com/photo-1758691461530-b215ed4ede6a?crop=entropy&cs=srgb&fm=jpg&ixid=M3w4NjAzNzl8MHwxfHNlYXJjaHwzfHxob3NwaXRhbCUyMGhlYWx0aGNhcmUlMjBkYXRhJTIwYW5hbHl0aWNzJTIwZGFzaGJvYXJkfGVufDB8fHx8MTc4NjgyMDk5N3ww&ixlib=rb-4.1.0&q=85&w=1200&h=1500&fit=crop",
    },
];
                ...
                <div data-testid="industries-grid" className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-6">
                    {industries.map((ind, i) => (
                        <motion.a
                            ...
                            className={`group relative block overflow-hidden border border-neutral-200 bg-white shadow-sm transition-shadow duration-200 hover:shadow-lg ${
                        ...
                        >
                            ...
                            <div className="absolute inset-x-0 bottom-0 p-6 md:p-8">
                                <h3 className="font-display text-2xl font-bold text-white drop-shadow-md md:text-3xl">
                                    {ind.title}
                                </h3>
