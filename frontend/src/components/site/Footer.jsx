...
export default function Footer() {
    return (
        <footer
            ...
            className="relative border-t border-white/10 bg-[#0A0A0C] pt-20 pb-10"
        >
            <div className="mx-auto max-w-7xl px-6 lg:px-10">
                <div className="grid gap-14 lg:grid-cols-12 lg:gap-10">
                    <div className="lg:col-span-5">
                        <div className="flex items-center gap-2">
                            <span className="grid h-9 w-9 place-items-center border border-white/20 bg-white/5 font-display text-sm font-bold text-white">
                                hq
                            </span>
                        ...
                        <p className="mt-6 font-display text-lg text-white/80">
                            Your trust is our responsibility.
                        </p>
                    </div>

                    <div className="lg:col-span-2">
                        <h4 className="text-xs uppercase tracking-[0.2em] text-white/50">Navigate</h4>
                    ...
                    <div className="lg:col-span-2">
                        <h4 className="text-xs uppercase tracking-[0.2em] text-white/50">Services</h4>
                        <ul className="mt-4 space-y-3">
                            {services.map((l) => (
                                <li key={l} className="text-sm text-white/70">{l}</li>
                            ))}
                        </ul>
                    </div>

                    <div className="lg:col-span-3">
                        <h4 className="text-xs uppercase tracking-[0.2em] text-white/50">Industries</h4>
